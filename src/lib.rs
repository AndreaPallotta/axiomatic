...
pub use memory::{
    ...
    VerifiedTheorem, VectorRecord,
};
pub use nn::{
    collect_parallel_self_play_trajectories, vectorize_proof_state, AdamOptimizer,
    DeepNeuralPolicy, DeepProofNetwork, ModelCheckpoint, ReplayBuffer, RewardConfig, RewardEngine,
    RollbackEvent, SupervisorAction, TrainingHealthStatus, TrainingMetrics, TrainingSupervisor,
    train_continuous_session, train_self_play_cycle,
};
...
pub use verifier::{
    ...
    InductionEngine, Lean4Validator, LeanValidationResult, MultiFormatExporter, ProofState,
    Tactic, Term,
};
