...
impl TheoryInventor {
        ...
        match seed % 12 {
                ...
                Equality::new(
                    Term::func(
                        ...
                        vec![
                            Term::func(
                                "+",
                                vec![Term::func("+", vec![v1.clone(), zero.clone()]), v2.clone()],
                            ),
                            v3.clone(),
                        ],
                    ),
                    Term::func(
                        "+",
                        vec![v3.clone(), Term::func("+", vec![v2.clone(), v1.clone()])],
                    ),
                )
            }
            2 => {
                ...
                Equality::new(
                    ...
                    Term::func(
                        "+",
                        vec![zero.clone(), Term::func("*", vec![one.clone(), v1.clone()])],
                    ),
                )
            }
            3 => {
                        ...
                        vec![
                            Term::func(
                                ...
                                vec![
                                    ...
                                    Term::func(
                                        "+",
                                        vec![v2.clone(), Term::func("-", vec![v2.clone()])],
                                    ),
                                ],
                            ),
                            one.clone(),
                ...
                Equality::new(
                    Term::func(
                        ...
                        vec![
                            Term::func(
                                "*",
                                vec![one.clone(), Term::func("+", vec![v1.clone(), v2.clone()])],
                            ),
                            zero.clone(),
                        ],
                    ),
            ...
            6 => {
                ...
                Equality::new(
                    ...
                    Term::func(
                        "*",
                        vec![one.clone(), Term::func("+", vec![v2.clone(), zero.clone()])],
                    ),
                )
            }
            7 => {
                ...
                Equality::new(
                    Term::func(
                        ...
                        vec![
                            Term::func(
                                "*",
                                vec![v1.clone(), Term::func("*", vec![one.clone(), v2.clone()])],
                            ),
                            one.clone(),
                        ],
                    ),
                    Term::func(
                        "*",
                        vec![one.clone(), Term::func("*", vec![v2.clone(), v1.clone()])],
                    ),
                )
            }
            10 => {
                ...
                Equality::new(
                    Term::func(
                        ...
                        vec![
                            Term::func(
                                "+",
                                vec![Term::func("+", vec![v1.clone(), v2.clone()]), v3.clone()],
                            ),
                ...
                Equality::new(
                    Term::func(
                        ...
                        vec![
                            Term::func(
                                "*",
                                vec![Term::func("*", vec![v1.clone(), one.clone()]), one.clone()],
                            ),
                            Term::func(
                                "*",
                                vec![Term::func("*", vec![v2.clone(), one.clone()]), one.clone()],
                            ),
                        ],
                    ),
                    Term::func("+", vec![v2.clone(), v1.clone()]),
                ...
                Equality::new(
                    Term::func(
                        ...
                        vec![Term::func(
                            ...
                            vec![Term::func(
                                "&",
                                vec![a.clone(), Term::func("|", vec![b.clone(), zero.clone()])],
                            )],
                        )],
                    ),
                    Term::func(
                        "&",
                        vec![b.clone(), Term::func("&", vec![a.clone(), one.clone()])],
                    ),
                )
            }
            4 => {
                    ...
                    Term::func(
                        ...
                        vec![Term::func(
                            ...
                            vec![Term::func(
                                ...
                                vec![Term::func(
                                    "!",
                                    vec![Term::func("&", vec![a.clone(), one.clone()])],
                                )],
                            )],
                        )],
                    ),
            ...
            4 => {
                ...
                Equality::new(
                    Term::func(
                        ...
                        vec![Term::func(
                            "*",
                            vec![one.clone(), Term::func("+", vec![x.clone(), zero.clone()])],
                        )],
                    ),
                    Term::func("*", vec![one.clone(), one.clone()]),
                )
                ...
                Equality::new(
                    Term::func(
                        ...
                        vec![
                            ...
                            Term::func(
                                "union",
                                vec![a.clone(), Term::func("comp", vec![b.clone()])],
                            ),
                        ],
                    ),
                ...
                Equality::new(
                    Term::func(
                        ...
                        vec![
                            ...
                            Term::func(
                                "inter",
                                vec![a.clone(), Term::func("union", vec![b.clone(), c.clone()])],
                            ),
                        ],
                    ),
            ...
            _ => {
                ...
                Equality::new(
                    Term::func(
                        ...
                        vec![Term::func(
                            "comp",
                            vec![Term::func("inter", vec![a.clone(), univ.clone()])],
                        )],
                    ),
                    Term::func("union", vec![a.clone(), empty.clone()]),
                )
    ...
    pub fn compute_complexity(conjecture: &Equality) -> f64 {
        ...
        let symbols_count = (conjecture.lhs.extract_symbols().len()
            + conjecture.rhs.extract_symbols().len()) as f64;
